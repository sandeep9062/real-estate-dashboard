...
"[project]/store/authSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    if (data && data.user && !data.token) {
        ...
        if (cookieToken) {
            ...
            if (data.token) {
                ...
                console.log("BaseQueryWithAuth - Stored response token in localStorage");
            } else {
                console.warn("BaseQueryWithAuth - No token found in cookies or response");
            }
        }
    }
    ...
    if (result.error && result.error.status === 401) {
        ...
        if (refreshResult.data) {
            ...
            if (typeof document !== "undefined") {
                document.cookie = "accessToken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=propertybulbul.com";
                document.cookie = "refreshToken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=propertybulbul.com";
...
const authApi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
    reducerPath: "authApi",
    baseQuery: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["baseQueryWithAuth"],
    tagTypes: [
        "User"
    ],
    endpoints: (builder)=>({
                ...
                async onQueryStarted (credentials, { dispatch, queryFulfilled }) {
                    try {
                        ...
                        if (data && data.user) {
                            ...
                            if (!token && data.token) {
                                token = data.token;
                                console.log("⚠️  Using token from response - cookies may not be set yet");
                            }
                            ...
                            if (token) {
                                ...
                                console.error("❌ Login failed - no token found in cookies, response, or localStorage");
                    ...
                    try {
                        ...
                        if (data && data.user) {
                            ...
                            if (token) {
                                ...
                                console.error("❌ Registration failed - no token found in cookies, response, or localStorage");
                    ...
                    try {
                        ...
                        if (data && data.user) {
                            ...
                            if (token) {
                                ...
                                console.log("✅ User data refreshed - token found:", token.substring(0, 20) + "...");
                            } else {
                                console.warn("⚠️  User data fetched but no token found - user may need to login again");
                            }
                        }
                    } catch (error) {
            ...
            logout: builder.mutation({
                ...
                async onQueryStarted (_, { dispatch, queryFulfilled }) {
                    try {
                        ...
                        const { logoutSuccess } = await __turbopack_context__.A("[project]/store/authSlice.ts [app-client] (ecmascript, async loader)");
...
const { useLoginMutation, useRegisterMutation, useGetCurrentUserQuery, useChangePasswordMutation, useLogoutMutation } = authApi;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/services/propertiesApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const propertiesApi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
...
"[project]/services/contactApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const contactApi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
...
"[project]/services/bookingApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const bookingApi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
...
"[project]/services/dashboardApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const notificationApi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$contactApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/contactApi.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$bookingApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/bookingApi.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboardApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/dashboardApi.ts [app-client] (ecmascript)");
...
const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["configureStore"])({
    reducer: {
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$propertiesApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["propertiesApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$propertiesApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["propertiesApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$contactApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contactApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$contactApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contactApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$bookingApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bookingApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$bookingApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bookingApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboardApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dashboardApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboardApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dashboardApi"].reducer,
        [__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$notificationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationApi"].reducerPath]: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$notificationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationApi"].reducer,
        auth: __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    },
    middleware: (getDefaultMiddleware)=>getDefaultMiddleware().concat(__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$contactApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contactApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$propertiesApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["propertiesApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$bookingApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bookingApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboardApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dashboardApi"].middleware, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$notificationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationApi"].middleware),
...
function StoreProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreProvider.useEffect": ()=>{
            ...
            const token = localStorage.getItem("token");
            if (user && token) {
                __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUser"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Provider"], {
        store: __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
        children: children
    }, void 0, false, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$StoreProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/StoreProvider.tsx [app-client] (ecmascript)");
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$core$2f$MantineProvider$2f$MantineProvider$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MantineProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$store$2f$StoreProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StoreProvider"], {
            children: children
        }, void 0, false, {
...
//# sourceMappingURL=_477fc6b0._.js.map