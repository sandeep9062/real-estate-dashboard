...
function Settings() {
    ...
    const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Settings.useSelector[currentUser]": (state)=>state.auth.user
    }["Settings.useSelector[currentUser]"]);
    ...
    const [updateUser, { isLoading: isProfileUpdating }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUpdateUserMutation"])();
    const [changePassword, { isLoading: isPasswordChanging }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChangePasswordMutation"])();
    ...
    const handleProfileUpdate = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error?.data?.message || "Failed to update profile");
        }
    };
    const handlePasswordChange = async (e)=>{
        ...
        if (!passwordData.currentPassword || !passwordData.newPassword || !passwordData.confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("All password fields are required");
            return;
        }
        if (passwordData.newPassword.length < 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("New password must be at least 6 characters long");
            return;
        }
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error?.data?.message || "Failed to change password");
        }
    };
...
_s(Settings, "mBlEoSluyqdU+XfGWAySFuLK+vU=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChangePasswordMutation"]
    ];
});
_c = Settings;
var _c;
...
//# sourceMappingURL=_4395973b._.js.map